      ...
      <div className="bg-gray-800 p-8 rounded-lg border border-gray-700 max-w-md w-full">
        ...
        <div className="mt-6 space-y-3">
          ...
          <button
            ...
            className="w-full bg-white hover:bg-gray-100 text-gray-900 p-3 rounded-lg font-semibold flex items-center justify-center"
          >
          ...
          <button
            ...
            className="w-full bg-gray-900 hover:bg-gray-950 text-white p-3 rounded-lg font-semibold flex items-center justify-center border border-gray-700"
          >
