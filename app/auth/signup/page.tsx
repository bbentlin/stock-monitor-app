...
const SignUpPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 flext items-center justify-center">
        ...
        <div className="mt-6">
          ...
          <div className="mt-4 grid grid-cols-2 gap-4">
            <button
              ...
              className="flex items-center justify-center px-4 py-2 border border-gray-600 rounded bg-gray-700 hover:bg-gray-600 text-white transition-colors"
            >
